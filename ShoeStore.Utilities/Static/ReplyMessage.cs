namespace ShoeStore.Utilities.Static
{
    public class ReplyMessage
    {
        ...
        public const string MESSAGE_EXCEPTION = "Hubo un error inesperado, comunicarse con el administrador (info@shoestore.com).";
